...
class OpenAIChatProvider(BaseProvider):
    ...
    def __init__(
        ...
        *,
        ...
        # MAX-TPS PATCH: http_read_timeout=0 means "no read timeout" (None),
        # so slow reasoning models don't get killed mid-stream.
        _read_timeout = config.http_read_timeout or None
        http_client = None
        if config.proxy:
